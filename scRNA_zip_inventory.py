...
def main() -> None:
    ...
    out_dir = root / "scRNA_analysis"
    out_dir.mkdir(exist_ok=True)

    z_endo = root / "(Supplementary_Dataset)_Endometrium_single_cell_data.zip"
    z_pcos = root / "(Supplementary_Dataset)_PCOS_single_cell_data.zip"
